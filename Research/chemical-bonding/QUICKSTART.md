...
python "$repo_root/Research/molecular-orbital/scripts/LaH10_CeH10_analysis/01_magnetic_test/analyze_magnetism.py"
...
# 2. 绘制能带和PDOS
cd ../../LaH10/bands/
python "$repo_root/Research/molecular-orbital/scripts/LaH10_CeH10_analysis/04_band_analysis/plot_bands_pdos.py" LaH10

cd ../../CeH10/bands/
python "$repo_root/Research/molecular-orbital/scripts/LaH10_CeH10_analysis/04_band_analysis/plot_bands_pdos.py" CeH10
...
```bash
cd LaH10/phonopy/
python "$repo_root/Research/molecular-orbital/MH10/LaH10-Tc-666-paw/analyze_phonon_modes.py"
...
python "$repo_root/Research/molecular-orbital/scripts/LaH10_CeH10_analysis/06_frozen_phonon/generate_displaced_structures.py" \
    ../POSCAR_optimized \
    --mode 25 \
...
```bash
# 方法1：使用批量提交脚本
bash "$repo_root/Research/molecular-orbital/scripts/LaH10_CeH10_analysis/06_frozen_phonon/batch_submit_vasp.sh" \
...
```bash
# 所有VASP计算完成后
python "$repo_root/Research/molecular-orbital/scripts/LaH10_CeH10_analysis/06_frozen_phonon/analyze_band_splitting.py" 25
...
**文件位置**：`Research/chemical-bonding/QUICKSTART.md`
**参考详细计划**：`Research/chemical-bonding/04_LaH10_CeH10_research_plan.md`
**工具文档**：`Research/molecular-orbital/scripts/LaH10_CeH10_analysis/README.md`
